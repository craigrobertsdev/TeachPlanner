...
{
    public async static Task<YearData?> GetYearData(this ApplicationDbContext context, TeacherId teacherId, int calendarYear, CancellationToken cancellationToken)
    {
