...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeachPlanner.Domain.Assessments.AssessmentResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TeachPlanner.Domain.Students.Students", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
            ...
            modelBuilder.Entity("TeachPlanner.Domain.Teachers.Teachers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
            ...
            modelBuilder.Entity("TeachPlanner.Domain.YearDataRecords.YearData", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("SubjectYearData", b =>
                {
                    ...
                    b.HasOne("TeachPlanner.Domain.YearDataRecords.YearData", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TeachPlanner.Domain.Assessments.Assessment", b =>
                {
                    ...
                    b.HasOne("TeachPlanner.Domain.Students.Students", null)
                        .WithMany("Assessments")
            ...
            modelBuilder.Entity("TeachPlanner.Domain.Assessments.AssessmentResult", b =>
                {
                    b.OwnsOne("TeachPlanner.Domain.Assessments.AssessmentResult.Grade#TeachPlanner.Domain.Assessments.AssessmentGrade", "Grade", b1 =>
                        {
            ...
            modelBuilder.Entity("TeachPlanner.Domain.Common.Planner.SchoolEvent", b =>
                {
                    b.OwnsOne("TeachPlanner.Domain.Common.Planner.SchoolEvent.Location#TeachPlanner.Domain.Common.Planner.Location", "Location", b1 =>
                        {
            ...
            modelBuilder.Entity("TeachPlanner.Domain.LessonPlans.LessonPlan", b =>
                {
                    ...
                    b.OwnsMany("TeachPlanner.Domain.LessonPlans.LessonPlan.Comments#TeachPlanner.Domain.LessonPlans.LessonComment", "Comments", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TeachPlanner.Domain.Reports.Report", b =>
                {
                    ...
                    b.HasOne("TeachPlanner.Domain.Teachers.Teachers", null)
                        .WithMany()
                    ...
                    b.OwnsMany("TeachPlanner.Domain.Reports.Report.ReportComments#TeachPlanner.Domain.Reports.ReportComment", "ReportComments", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TeachPlanner.Domain.Teachers.Teachers", b =>
                {
                    b.OwnsMany("TeachPlanner.Domain.Teachers.Teachers.YearDataHistory#TeachPlanner.Domain.Teachers.YearDataEntry", "YearDataHistory", b1 =>
                        {
            ...
            modelBuilder.Entity("TeachPlanner.Domain.TermPlanners.TermPlanner", b =>
                {
                    b.HasOne("TeachPlanner.Domain.YearDataRecords.YearData", null)
                        .WithOne("TermPlanner")
                        .HasForeignKey("TeachPlanner.Domain.TermPlanners.TermPlanner", "YearDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TeachPlanner.Domain.Assessments.SummativeAssessment", b =>
                {
                    b.HasOne("TeachPlanner.Domain.Assessments.AssessmentResult", "Result")
                        .WithMany()
