...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230807063244_Fix-LP-Resource")]
    partial class FixLPResource
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.TermPlannerAggregate.Calendar", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
            ...
            modelBuilder.Entity("LessonPlanResource", b =>
                {
                    b.Property<Guid>("LessonPlan1Id")
                        .HasColumnType("char(36)");

                    b.Property<Guid>("ResourceId")
                        .HasColumnType("char(36)");

                    b.HasKey("LessonPlan1Id", "ResourceId");
            ...
            modelBuilder.Entity("Domain.WeekPlannerAggregate.WeekPlanner", b =>
                {
                    ...
                    b.HasOne("Domain.TermPlannerAggregate.Calendar", null)
                        .WithMany()
