...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230729212402_ChangeIdTypes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.LessonPlanAggregate.LessonPlan", b =>
                {
                    ...
                    b.OwnsMany("Domain.Assessments.ValueObjects.AssessmentIdForReference", "AssessmentIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.ToTable("lesson_assessment_ids", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("LessonId");
                        });

                    b.OwnsMany("Domain.ResourceAggregate.ValueObjects.ResourceIdForReference", "ResourceIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.ToTable("lesson_resource_ids", (string)null);
                    ...
                    b.OwnsMany("Domain.Assessments.ValueObjects.AssessmentIdForReference", "AssessmentIds", b1 =>
                        {
                            ...
                            b1.ToTable("student_assessment_ids", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("StudentId");
                        });

                    b.OwnsMany("Domain.ReportAggregate.ValueObjects.ReportIdForReference", "ReportIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.ToTable("student_report_ids", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("StudentId");
                        });

                    b.OwnsMany("Domain.SubjectAggregates.ValueObjects.SubjectIdForReference", "SubjectIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.ToTable("student_subject_ids", (string)null);
            ...
            modelBuilder.Entity("Domain.TeacherAggregate.Teacher", b =>
                {
                    b.OwnsMany("Domain.StudentAggregate.ValueObjects.StudentIdForReference", "StudentIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.ToTable("teacher_student_ids", (string)null);
                    ...
                    b.OwnsMany("Domain.Assessments.ValueObjects.AssessmentIdForReference", "AssessmentIds", b1 =>
                        {
                            ...
                            b1.ToTable("teacher_assessment_ids", (string)null);
                    ...
                    b.OwnsMany("Domain.ReportAggregate.ValueObjects.ReportIdForReference", "ReportIds", b1 =>
                        {
                            ...
                            b1.ToTable("teacher_report_ids", (string)null);
                    ...
                    b.OwnsMany("Domain.ResourceAggregate.ValueObjects.ResourceIdForReference", "ResourceIds", b1 =>
                        {
                            ...
                            b1.ToTable("teacher_resource_ids", (string)null);
                    ...
                    b.OwnsMany("Domain.SubjectAggregates.ValueObjects.SubjectIdForReference", "SubjectIds", b1 =>
                        {
                            ...
                            b1.ToTable("teacher_subject_ids", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("TeacherId");
                        });

                    b.OwnsOne("Domain.UserAggregate.ValueObjects.UserIdForReference", "UserId", b1 =>
                        {
                            b1.Property<Guid>("TeacherId")
                                .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Domain.TermPlannerAggregate.TermPlanner", b =>
                {
                    b.OwnsMany("Domain.Common.Planner.ValueObjects.SchoolEventIdForReference", "SchoolEventIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("Domain.WeekPlannerAggregate.ValueObjects.WeekPlannerIdForReference", "WeekPlannerIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.TimeTableAggregate.WeekPlanner", b =>
                {
                    b.OwnsMany("Domain.LessonPlanAggregate.ValueObjects.LessonPlanIdForReference", "LessonPlanIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
