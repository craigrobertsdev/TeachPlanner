        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_LessonPlans_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonAssessmentIds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonAssessmentIds_LessonPlans_LessonId",
                        column: x => x.LessonId,
                        principalTable: "LessonPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonResourceIds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonResourceIds_LessonPlans_LessonId",
                        column: x => x.LessonId,
                        principalTable: "LessonPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonAssessmentIds_LessonId",
                table: "LessonAssessmentIds",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonResourceIds_LessonId",
                table: "LessonResourceIds",
                column: "LessonId");
