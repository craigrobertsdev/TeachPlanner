...
function LessonHeader({ lessonNumber, rowIndex, startTime, endTime, classList }: LessonHeaderProps) {
  return (
    <div
      ...
      className={`row-start-${rowIndex} col-start-1 items-center flex flex-col justify-center border-l-2 border-r-2 border-b-2 border-darkGreen text-center text-lg font-semibold ${
        classList ? classList : ""
      }`}>
