...
public sealed class Teacher : AggregateRoot
{
    ...
    private readonly Dictionary<int, Guid> _yearDataHistory = new();
    ...
    public IReadOnlyDictionary<int, Guid> YearDataHistory => _yearDataHistory.AsReadOnly();
    ...
    //    {
    //        _yearDataHistory.Add(yearData.CalendarYear, yearData);
    //    }
    //}
    ...
    //    {
    //        _yearDataHistory.Add(year, YearData.Create(year));
    //    }
    //}
    ...
    //    if (!YearDataExists(year))
    //    {
    //        _yearDataHistory.Add(year, YearData.Create(year, students));
    //    }
